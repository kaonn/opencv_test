...
def find_tests(filename):
    ...
    cv2.imwrite("saved_images/t1.png", test1section)
    test1section_show = resize(test1section, width = 1000)
    cv2.imshow("test1section", test1section_show)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    ...
    cv2.imwrite("saved_images/t2.png", test2section)
    test2section_show = resize(test2section, width = 1000)
    cv2.imshow("test2section", test2section_show)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    ...
    cv2.imwrite("saved_images/t3.png", test3section)
    test3section_show = resize(test3section, width = 1000)
    cv2.imshow("test3section", test3section_show)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    ...
    cv2.imwrite("saved_images/t4.png", test4section)
    test4section_show = resize(test4section, width = 1000)
    cv2.imshow("test4section", test4section_show)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
...
[www,xxx,yyy,zzz] = find_tests(filename)


"""
www = resize(www, width = 1000)
cv2.imshow("t1", www)
cv2.waitKey(0)
cv2.destroyAllWindows()


xxx = resize(xxx, width = 1000)
cv2.imshow("t2", xxx)
cv2.waitKey(0)
cv2.destroyAllWindows()
...
yyy = resize(yyy, width = 1000)
cv2.imshow("t3", yyy)
cv2.waitKey(0)
cv2.destroyAllWindows()


zzz = resize(zzz, width = 1000)
cv2.imshow("t4", zzz)
cv2.waitKey(0)
cv2.destroyAllWindows()
